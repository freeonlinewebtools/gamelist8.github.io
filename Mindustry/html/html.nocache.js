function html() {
    var O = 'bootstrap'
      ...
      , _b = 'html.devmode.js'
      , ac = '6B7B6BB8AC29E8E3952F79D5483498AA'
      , bc = ':1'
      , cc = ':'
      , dc = '.cache.js'
      , ec = 'link'
      ...
      , hc = 'href'
      , ic = 'loadExternalRefs'
      , jc = 'gwt/chrome/chrome.css'
      , kc = 'end'
      , lc = 'http:'
      , mc = 'file:'
      , nc = '_gwt_dummy_'
      , oc = '__gwtDevModeHook:html'
      , pc = 'Ignoring non-whitelisted Dev Mode URL: '
      , qc = ':moduleBase';
    var o = window;
    var p = document;
    r(O, P);
    ...
    function A(k) {
        ...
        if (html.__errFn) {
            n.onerror = function() {
                html.__errFn(S, new Error(nb + code))
            }
        }
    ...
    var H = F();
    if (o) {
        var I = !!(o.location.protocol == lc || o.location.protocol == mc);
